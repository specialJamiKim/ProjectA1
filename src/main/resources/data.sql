...
VALUES ('부산 부산진구 중앙대로 708 부산파이낸스센터' , '18:30' , 10000, '굿케어헬스', '09:00' , '010-1234-5678' , 'health1.png');

INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number, image_path)
VALUES ('부산광역시 부산진구 중앙대로 709' , '20:30' , 12000, '나이스헬스', '08:30' , '010-1234-5678'  , 'health2.png');

INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number, image_path)
VALUES ('부산광역시 부산진구 서전로10번길 61 쥬디스태화신관' , '21:00' , 8000, '람보헬스', '09:00' , '010-1234-5678' , 'health3.png');

INSERT INTO f_center (address, closing_time, daily_pass_price, name, open_time, phone_number, image_path)
VALUES ('부산 부산진구 가야대로 772' , '23:00' , 10000, '진짜로피트니스', '07:00' , '010-1234-5678' , 'health4.png');
